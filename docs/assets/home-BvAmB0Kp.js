...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(e,t,n){return new zi({name:`SphericalGaussianBlur`,defines:{SAMPLES:Xa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function po(){return new zi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function mo(){return new zi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ho(),fragmentShader:`
	...
	`}var go=class extends Ut{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new xi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},nl=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},rl=new ga(-1,1,1,-1,0,1),il=new class extends Cr{constructor(){super(),this.setAttribute(`position`,new dr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new dr([0,2,0,0,2,0],2))}},al=class{constructor(e){this._mesh=new qr(il,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,rl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},ol=class extends nl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof zi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ii.clone(e.uniforms),this.material=new zi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new al(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},sl=class extends nl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},cl=class extends nl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},ll=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new q);this._width=n.width,this._height=n.height,t=new Ut(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ol(tl),this.copyPass.material.blending=0,this.timer=new xa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}sl!==void 0&&(r instanceof sl?n=!0:r instanceof cl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new q);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ul=class extends nl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Z}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},dl={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Z(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};fl.BlurDirectionX=new q(1,0),fl.BlurDirectionY=new q(0,1);var pl=[`idle`,`listening`,`thinking`,`working`,`speaking`,`complete`],ml=e=>e===`thinking`?0:e===`working`?1:null,hl=1.24;function gl(e){let t=`idle`,n=`idle`,r=`steady`,i=0,a=0,o=Array.from({length:e},(e,t)=>({head:2,direction:0,wait:0,speed:.76+t*7%11*.019,rest:.25+t*3%7*.065,entry:t*.61803398875%1*.85})),s=()=>o.filter(e=>e.head<hl),c=()=>{t=n,i=0,a=0,r=t===`complete`?`completing`:`steady`;for(let e of o)e.wait=e.entry};return{packets:o,request(e){pl.includes(e)&&(n=e)},step(e,l=!1){if(l){for(let e of o)e.head=2;t!==n&&c(),r=`steady`;return}i+=e;for(let t of o)t.head<hl&&(t.head+=e*t.speed,t.head>=hl&&(t.head=2,t.wait=t.rest));n===t?(a=0,r=t===`complete`&&i<2.3?`completing`:`steady`):t===`complete`&&n===`idle`&&i<2.3?r=`completing`:s().length?(r=`draining`,a=0):(r=`settling`,a+=e,a>=.16&&c());let u=ml(t);if(n===t&&u!==null&&r===`steady`)for(let t of o)t.head>=hl&&(t.wait-=e,t.wait<=0&&(t.head=0,t.direction=u))},snapshot(){let e=s();return{mode:t,requested:n,phase:r,age:i,activeTrails:e.length,incoming:e.filter(e=>e.direction===0).length,outgoing:e.filter(e=>e.direction===1).length,wave:t===`complete`?Math.min(1,i/2.3):0}}}}var _l=e=>Math.max(0,Math.min(1,e)),vl=(e,t,n)=>{let r=_l((n-e)/(t-e));return r*r*(3-2*r)},yl=4.1,bl=1.6;function xl(e){let t=!e,n=e?0:yl,r=0,i=!1;return{reset(){t=!0,n=0,r=0,i=!1},present(){t=!0},enter(){i=!0},step(e,a=!1){t&&(n<4.1&&(n=a?yl:Math.min(yl,n+e),!a)||i&&(r=a?1:Math.min(1,r+e/bl)))},snapshot(){return{assembly:n,assembled:n>=yl,entering:i,entry:r,stage:n<.28?`black`:n<1.1?`core`:n<1.9?`polygons`:n<4.1?`web`:i?`entering`:`ready`,shellScale:1+7*r**2.6,dashboardReveal:vl(.38,1,r),opacity:1-vl(.62,1,r)}}}}function Sl(t,n,r,i={}){let a=xl(!!i.intro),o={value:i.intro?0:10},s=!i.intro,c=!1,l=new el({canvas:t,alpha:!0,antialias:!0,premultipliedAlpha:!1,powerPreference:`low-power`});l.setClearColor(0,0),l.toneMapping=4,l.toneMappingExposure=1.15;let u=new kn,d=new ha(39,1,.1,30);d.position.set(0,.1,6.1),d.lookAt(0,0,0);let f=new xn,p=new xn,m=new xn,h=new xn;f.add(p,m,h),u.add(f);let g=[],_=[],v=41837,y=()=>(v=Math.imul(v,1664525)+1013904223>>>0,v/4294967296),b=(e,t,n)=>new J(Math.cos(e)*Math.cos(t)*n,Math.sin(t)*n,Math.sin(e)*Math.cos(t)*n),x=(e,t)=>{let n=new zi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uColor:{value:new Z(e)},uOpacity:{value:t},uEnergy:{value:1},uAssembly:o},vertexShader:`attribute float aReveal;varying float vReveal;varying float vDepth;void main(){vReveal=aReveal;vec4 world=modelMatrix*vec4(position,1.0);vDepth=mix(0.13,1.0,smoothstep(-1.8,1.7,world.z));gl_Position=projectionMatrix*viewMatrix*world;}`,fragmentShader:`uniform vec3 uColor;uniform float uOpacity;uniform float uEnergy;uniform float uAssembly;varying float vReveal;varying float vDepth;void main(){float ink=smoothstep(vReveal,vReveal+.07,uAssembly);if(ink<.001)discard;gl_FragColor=vec4(uColor*uEnergy,uOpacity*vDepth*ink);}`});return _.push(n),n},S=x(`#ffad35`,.68),C=x(`#bd6827`,.46),w=x(`#ffdb7e`,.86),T=x(`#ffe9a8`,.95),E=(e,t,n)=>{let r=new Cr;r.setAttribute(`position`,new dr(t,3)),g.push(r),e.add(new pi(r,n))},D=(e,t,n)=>{e.push(t.x,t.y,t.z,n.x,n.y,n.z)},O=[],k=[],A=[],j=[],ee=[];for(let e=0;e<27;e++){let t=-1.34+e*.103,n=1.45+y()*.12,r=y()*6.28;for(let i=0;i<152;i++){if(y()<.24)continue;let a=i/152*Math.PI*2+r,o=a+Math.PI*2/152*.86;D(e%4==0?j:O,b(a,t,n),b(o,t,n)),y()<.07&&D(A,b(a,t,n),b(a,t+.035,n+.06))}}for(let e=0;e<42;e++){let t=e/42*Math.PI*2+.05;for(let e=0;e<60;e++){if(y()<.33)continue;let n=-1.45+e*.048,r=1.53;D(k,b(t,n,r),b(t,n+.041,r))}}for(let e=0;e<110;e++){let t=y()*Math.PI*2,n=(y()-.5)*2.6,r=1.14+y()*.52,i=.05+y()*.25,a=.025+y()*.1,o=[b(t,n,r),b(t+i,n,r),b(t+i,n+a,r),b(t,n+a,r)],s=o.map(()=>y()>.18),c=[];if(r>1.4&&e%2==0){for(let e=0;e<4;e++){let t=[];for(let n=0;n<4&&s[(e+n)%4];n++)t.push((e+n)%4);t.length>c.length&&(c=t)}c.length<2&&(c=[])}for(let e=0;e<4;e++)s[e]&&!c.includes(e)&&D(A,o[e],o[(e+1)%4]);if(c.length){let t=[...c.map(e=>o[e]),o[(c.at(-1)+1)%4]];e%4==0&&t.reverse(),ee.push(t)}for(let e=0;e<3+Math.floor(y()*6);e++){let a=n+e*.012;D(k,b(t+.02,a,r+.004),b(t+i*(.25+y()*.7),a,r+.004))}if(e%4==0){let e=o[1];D(j,e,e.clone().multiplyScalar(1.1))}}E(p,O,S),E(p,k,C),E(p,A,S),E(p,j,w);let M=[];for(let e=0;e<85;e++){let t=y()*6.28,n=(y()-.5)*2.5,r=.32+y()*.8;for(let e=0;e<12;e++)D(M,b(t+e*.027,n,r),b(t+(e+1)*.027,n+.008,r));e%3==0&&D(M,b(t,n,.34),b(t,n,r))}E(m,M,S);let N=[];for(let e=0;e<9;e++){let t=new xn,n=[],r=.52+e*.153;t.rotation.set(.3+y()*2.6,y()*Math.PI,y()*Math.PI),f.add(t);for(let e=0;e<4;e++){let t=e*Math.PI/2+y()*.15,i=.65+y()*.7;for(let e=0;e<80;e++){let a=t+i*e/80,o=t+i*(e+1)/80;D(n,new J(Math.cos(a)*r,Math.sin(a)*r,0),new J(Math.cos(o)*r,Math.sin(o)*r,0)),e%8==0&&D(n,new J(Math.cos(a)*r,Math.sin(a)*r,0),new J(Math.cos(a)*(r+.018),Math.sin(a)*(r+.018),0))}}E(t,n,e%3==0?w:S),N.push({group:t,speed:(e%2?1:-1)*(.023+y()*.018),phase:y()*6.28,baseX:t.rotation.x,baseY:t.rotation.y})}for(let e=0;e<3;e++){let t=new Di(.19+e*.13,+(e===0)),n=new ki(t);t.dispose(),g.push(n);let r=new pi(n,e===0?T:w);r.rotation.set(e*.4,e*.8,e*.23),h.add(r)}let P=[],F=[],te=[];for(let e=0;e<1550;e++){let t=e<120?.15+y()*.28:e<350?.55+y()*.65:1.38+y()*.25,n=b(y()*6.28,Math.asin(y()*2-1),t);P.push(n.x,n.y,n.z),F.push((.7+y()*1.2)*(e<120?1.4:1)),te.push(y()*6.28)}let I=new Cr;I.setAttribute(`position`,new dr(P,3)),I.setAttribute(`aSize`,new dr(F,1)),I.setAttribute(`aPhase`,new dr(te,1)),g.push(I);let ne=new zi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uTime:{value:0},uPixelRatio:{value:1},uEnergy:{value:1},uAssembly:o},vertexShader:`attribute float aReveal;uniform float uAssembly;attribute float aSize;attribute float aPhase;uniform float uTime;uniform float uPixelRatio;varying float vLight;void main(){vec4 w=modelMatrix*vec4(position,1.0);vec4 v=viewMatrix*w;vLight=smoothstep(aReveal,aReveal+.25,uAssembly)*mix(.2,1.0,smoothstep(-1.6,1.6,w.z))*(.65+.35*sin(uTime*.7+aPhase));gl_Position=projectionMatrix*v;gl_PointSize=aSize*uPixelRatio*(7.0/-v.z);}`,fragmentShader:`uniform float uEnergy;varying float vLight;void main(){float r=length(gl_PointCoord-.5);if(r>.5)discard;float light=exp(-r*r*18.0);gl_FragColor=vec4(vec3(1.0,.68,.22)*uEnergy,light*vLight);}`});_.push(ne),p.add(new yi(I,ne));let re=97331,ie=()=>(re=Math.imul(re,1664525)+1013904223>>>0,re/4294967296),ae=[],oe=[],L=[],R=[],se=[],ce=[],le=[];for(let e of ee){let t=e.slice(1).reduce((t,n,r)=>t+n.distanceTo(e[r]),0),n=.1+ie()*.07,r=t*(.42+ie()*.24),i=n*(.6+ie()*1.8),a=ie()*(t+r+i),o=0;for(let s=1;s<e.length;s++){let c=e[s-1],l=e[s],u=o+c.distanceTo(l);D(ae,c,l),oe.push(o,u);for(let e=0;e<2;e++)L.push(t),R.push(n),se.push(a),ce.push(r),le.push(i);o=u}}let ue=new Cr;for(let[e,t,n]of[[`position`,ae,3],[`aDistance`,oe,1],[`aLength`,L,1],[`aSpeed`,R,1],[`aOffset`,se,1],[`aTail`,ce,1],[`aGap`,le,1]])ue.setAttribute(e,new dr(t,n));g.push(ue);let de=new zi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uColor:{value:new Z(`#ffad35`)},uOpacity:{value:.68},uEnergy:{value:1},uTime:{value:0},uMotion:{value:1},uAssembly:o},vertexShader:`attribute float aReveal;varying float vReveal;attribute float aDistance;attribute float aLength;attribute float aSpeed;attribute float aOffset;attribute float aTail;attribute float aGap;uniform float uTime;varying float vDepth;varying float vDistance;varying float vHead;varying float vTail;void main(){vReveal=aReveal;vec4 world=modelMatrix*vec4(position,1.0);vDepth=mix(.13,1.0,smoothstep(-1.8,1.7,world.z));vDistance=aDistance;vHead=mod(uTime*aSpeed+aOffset,aLength+aTail+aGap);vTail=aTail;gl_Position=projectionMatrix*viewMatrix*world;}`,fragmentShader:`uniform float uAssembly;varying float vReveal;uniform vec3 uColor;uniform float uOpacity;uniform float uEnergy;uniform float uMotion;varying float vDepth;varying float vDistance;varying float vHead;varying float vTail;void main(){float head=1.0-smoothstep(vHead-.008,vHead,vDistance);float tail=smoothstep(vHead-vTail,vHead-vTail+.045,vDistance);float ink=mix(1.0,head*tail,uMotion)*smoothstep(vReveal,vReveal+.07,uAssembly);if(ink<.005)discard;gl_FragColor=vec4(uColor*uEnergy,uOpacity*vDepth*ink);}`});_.push(de),p.add(new pi(ue,de)),t.dataset.circuitPaths=String(ee.length);let fe=[],pe=[],me=gl(26);for(let e=0;e<26;e++){let e=ie()*Math.PI*2,t=Math.asin(ie()*1.8-.9);ie();let n=b(e-.16,t,.26);for(let r=1;r<=18;r++){let i=r/18,a=.26+i*1.28,o=b(e+Math.floor(r/4)*.045-.16,t+(r>8?.07:0)-(r>13?.035:0),a);D(fe,n,o),pe.push((r-1)/18,i),n=o}}let he=new cr(new Float32Array(pe.length).fill(2),1).setUsage(ze),ge=new cr(new Float32Array(pe.length),1).setUsage(ze),_e=new Cr;_e.setAttribute(`position`,new dr(fe,3)),_e.setAttribute(`aProgress`,new dr(pe,1)),_e.setAttribute(`aHead`,he),_e.setAttribute(`aDirection`,ge),g.push(_e);let ve=new zi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uActivity:{value:0}},vertexShader:`attribute float aProgress;attribute float aHead;attribute float aDirection;varying float vProgress;varying float vHead;varying float vDirection;varying float vDepth;void main(){vec4 w=modelMatrix*vec4(position,1.0);vDepth=mix(.12,1.0,smoothstep(-1.7,1.7,w.z));vProgress=aProgress;vHead=aHead;vDirection=aDirection;gl_Position=projectionMatrix*viewMatrix*w;}`,fragmentShader:`uniform float uActivity;varying float vProgress;varying float vHead;varying float vDirection;varying float vDepth;void main(){float position=mix(1.0-vProgress,vProgress,vDirection);float d=vHead-position;float ink=smoothstep(0.0,.035,d)*(1.0-smoothstep(.05,.24,d));if(ink<.008)discard;gl_FragColor=vec4(vec3(1.0,.70,.26),ink*vDepth*uActivity*.9);}`});_.push(ve),m.add(new pi(_e,ve));let ye=new xn,be=x(`#ffdc8b`,0);f.add(ye);for(let e=0;e<3;e++){let t=[];for(let e=0;e<=160;e++){let n=e/160*Math.PI*2;t.push(new J(Math.cos(n),Math.sin(n),0))}let n=new Cr().setFromPoints(t);g.push(n);let r=new li(n,be);r.rotation.set(e*.77,e*.92,0),ye.add(r)}u.traverse(e=>{if(!(e instanceof pi||e instanceof li))return;let t=e.geometry,n=t.getAttribute(`position`).count,r=h.children.indexOf(e),i=N.findIndex(t=>t.group===e.parent),a=r===0?.28:r>0?.9+(r-1)*.2:e.parent===p?1.9:i>=0?1.14+i*.075:1.08,o=r===0?.25:r>0?.32:e.parent===p?1.5:.6,s=r===0?.38:e.parent===p?.35:.3,c=Array.from({length:n},(e,t)=>a+Math.floor(t/2)*.61803398875%1*o+t%2*s);t.setAttribute(`aReveal`,new dr(c,1))}),I.setAttribute(`aReveal`,new dr(te.map((e,t)=>(t<120?.55:t<350?1.25:2.15)+e/6.28*(t<350?.55:1.3)),1));let xe=new ll(l),Se=new ul(u,d),Ce=new fl(new q(512,512),.95,.45,.13);xe.addPass(Se),xe.addPass(Ce);let we=new ol({uniforms:{tDiffuse:{value:null},uEntry:{value:0},uOpacity:{value:1}},vertexShader:`varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}`,fragmentShader:`uniform float uEntry;uniform float uOpacity;uniform sampler2D tDiffuse;varying vec2 vUv;void main(){vec3 light=texture2D(tDiffuse,vUv).rgb;light=vec3(1.0)-exp(-light*1.25);float a=clamp(max(max(light.r,light.g),light.b),0.0,1.0);float fade=mix(1.0-smoothstep(.43,.5,length(vUv-.5)),1.0,smoothstep(0.0,.25,uEntry));gl_FragColor=vec4(light/max(a,.00001),a*fade*uOpacity);}`});xe.addPass(we);let Te=0,Ee=0,De=0,Oe=0,ke=0,z=1,Ae=!1,B=!1,je=!1,V=!0,Me=1,H=1,U=!1,Ne=0,Pe=0,Fe={listening:0,thinking:0,working:0,speaking:0,complete:0},Ie=matchMedia(`(prefers-reduced-motion: reduce)`),Le=0,Re=0,Be=()=>{let t=Math.max(1,n.clientWidth),r=Math.max(1,n.clientHeight);if(t===Le&&r===Re)return;Le=t,Re=r;let a=Math.min(devicePixelRatio,1.5);if(l.setPixelRatio(a),l.setSize(t,r,!1),xe.setPixelRatio(a),xe.setSize(t,r),d.aspect=t/r,i.hero){let t=e(innerWidth,innerHeight).base;d.fov=Ct.radToDeg(2*Math.atan(Math.tan(Ct.degToRad(39/2))*r/t))}d.updateProjectionMatrix(),ne.uniforms.uPixelRatio.value=a,He()},Ve=e=>{if(Te=0,Ae||B||document.hidden||!je)return;let n=!Ie.matches&&!U,l=Math.min((e-Ee)/1e3,.07)*H;if(n&&e-Ee<32){Te=requestAnimationFrame(Ve);return}Ee=e,n&&(De+=l),a.step(n?l:0,Ie.matches);let u=a.snapshot();o.value=u.assembly,f.visible=u.assembly>=.28,f.position.y=0,p.scale.setScalar(u.shellScale),m.scale.setScalar(1+(u.shellScale-1)*.15);for(let e=0;e<N.length;e++)N[e].group.scale.setScalar(1+(u.shellScale-1)*(.25+e*.08));we.uniforms.uEntry.value=u.entry,we.uniforms.uOpacity.value=u.opacity,u.entering&&i.onEntryProgress?.(u.dashboardReveal),(n||Ie.matches)&&me.step(n?l:0,Ie.matches);let d=me.snapshot(),g=d.mode,_=Ie.matches?1:n?1-Math.exp(-l*3.2):0;for(let e of Object.keys(Fe)){let t=e===`speaking`?d.requested===`speaking`:g===e;Fe[e]+=(+!!t-Fe[e])*_}let v=Fe.listening,y=Fe.thinking*Me,b=Fe.working*Me,x=v+Fe.speaking,E=x>0?Oe:0;ke+=(E-ke)*(Ie.matches?1:n?1-Math.exp(-l*(E>ke?19:7)):0);let D=y+b,O=1+x*ke*.35+D*.08;z+=(O-z)*_,n&&(Ne+=l*(1+D*.65),Pe+=l*(1+D*2.4)),f.rotation.set(.12+Math.sin(De*.07)*.04+x*.055,De*.045,-.12+x*.05),p.rotation.y=De*.034,m.rotation.set(Pe*-.036,Pe*-.06,.22+y*.09*Math.sin(De*.4)),h.rotation.set(Pe*.16,Pe*-.22,.3),h.scale.setScalar(1-y*.24+x*ke*.18),h.children.forEach((e,t)=>{e.rotation.y=Pe*(t%2?-.35:.22),e.rotation.z=Pe*(t%2?.2:-.18)});for(let e of N){n&&(e.group.rotation.z+=l*e.speed*(1+D*7));let t=y*(.5+.5*Math.sin(De*.56))**12*.5;e.group.rotation.x=e.baseX*(1-t)+.7*t+D*.1*Math.sin(De*.5+e.phase),e.group.rotation.y=e.baseY*(1-t)+.9*t+D*.08*Math.cos(De*.38+e.phase)}f.scale.setScalar(1+Math.sin(De*.65)*.006+x*ke*.014);for(let e of[S,C,w,T])e.uniforms.uEnergy.value=z;T.uniforms.uEnergy.value=z+y*.55+b*.18+x*ke*.15,C.uniforms.uEnergy.value=z*(1-D*.18),ne.uniforms.uTime.value=De,ne.uniforms.uEnergy.value=z,de.uniforms.uTime.value=Ne,de.uniforms.uEnergy.value=z+b*.15,de.uniforms.uMotion.value=+!Ie.matches;for(let e=0;e<me.packets.length;e++){let t=me.packets[e];he.array.fill(t.head,e*36,(e+1)*36),ge.array.fill(t.direction,e*36,(e+1)*36)}he.needsUpdate=!0,ge.needsUpdate=!0,ve.uniforms.uActivity.value=u.assembled?Math.min(1,D):0;let k=g===`complete`?d.wave:1;ye.scale.setScalar(.25+k*1.46),be.uniforms.uOpacity.value=g===`complete`?Math.sin(k*Math.PI)*.65:0,Ce.strength=.95+x*ke*.08,xe.render(),t.dataset.rendered=`true`,t.dataset.scene=`spatial-hologram`,t.dataset.mode=g,t.dataset.requested=d.requested,t.dataset.transition=d.phase,t.dataset.incoming=String(d.incoming),t.dataset.outgoing=String(d.outgoing),t.dataset.wave=String(g===`complete`?k:0),t.dataset.audioLevel=ke.toFixed(3),t.dataset.assembly=u.stage,t.dataset.assemblyTime=u.assembly.toFixed(3),t.dataset.entry=u.entry.toFixed(3),t.dataset.shellScale=u.shellScale.toFixed(3),t.dataset.coreScale=h.scale.x.toFixed(3),t.dataset.speakingWeight=Fe.speaking.toFixed(3),t.dataset.thinkingWeight=Fe.thinking.toFixed(3),u.assembled&&!s&&(s=!0,i.onIntroComplete?.()),u.entry===1&&!c&&(c=!0,i.onEntered?.()),g===`complete`&&d.requested===`complete`&&(d.age>=2.3||Ie.matches)&&(me.request(`idle`),r?.()),n&&V&&(Te=requestAnimationFrame(Ve))};function He(){je&&!Te&&!Ae&&!B&&!document.hidden&&(Te=requestAnimationFrame(Ve))}let Ue=()=>{document.hidden?(cancelAnimationFrame(Te),Te=0):(Ee=performance.now(),He())},We=e=>{e.preventDefault(),B=!0,cancelAnimationFrame(Te),Te=0},Ge=()=>{qe().catch(()=>{Ae||i.onError?.()})},Ke=()=>{B=!1,Ge()};async function qe(){je=!1,t.dataset.warmed=`false`,await l.compileAsync(u,d),!Ae&&(f.visible=!0,o.value=10,xe.render(),await new Promise(e=>requestAnimationFrame(()=>e())),!Ae&&(o.value=a.snapshot().assembly,f.visible=o.value>=.28,xe.render(),await new Promise(e=>requestAnimationFrame(()=>e())),!Ae&&(je=!0,t.dataset.warmed=`true`,Ee=performance.now(),He(),i.onReady?.())))}let W=new ResizeObserver(Be);return W.observe(n),document.addEventListener(`visibilitychange`,Ue),Ie.addEventListener(`change`,He),t.addEventListener(`webglcontextlost`,We),t.addEventListener(`webglcontextrestored`,Ke),Be(),Ge(),{present(){a.present(),Ee=performance.now(),He()},replay(){a.reset(),s=!1,c=!1,Ee=performance.now(),He()},enter(){a.enter(),He()},setActive(e){V=e,Ee=performance.now(),e?He():(cancelAnimationFrame(Te),Te=0)},update(e,t){me.request(e),Oe=Math.min(1,Math.max(0,t)),He()},snapshot:()=>me.snapshot(),configure(e){Me=e.intensity,H=e.pace,U=e.paused,He()},dispose(){Ae=!0,cancelAnimationFrame(Te),W.disconnect(),document.removeEventListener(`visibilitychange`,Ue),Ie.removeEventListener(`change`,He),t.removeEventListener(`webglcontextlost`,We),t.removeEventListener(`webglcontextrestored`,Ke),g.forEach(e=>e.dispose()),_.forEach(e=>e.dispose()),Se.dispose(),Ce.dispose(),we.dispose(),xe.dispose(),l.dispose(),l.forceContextLoss()}}}var Cl=document.querySelector(`#orb`),wl=Cl.parentElement,Tl=document.querySelector(`#motion`),El=matchMedia(`(prefers-reduced-motion: reduce)`),Dl,Ol=!1;function kl(){Tl.hidden=!Dl||El.matches,Tl.setAttribute(`aria-label`,Ol?`Resume orb animation`:`Pause orb animation`),Tl.querySelector(`.motion-label`).textContent=Ol?`Play`:`Pause`,Tl.querySelector(`.motion-icon`).textContent=Ol?`▷`:`Ⅱ`}function Al(){wl.classList.remove(`ready`),Tl.hidden=!0,Dl?.dispose(),Dl=void 0}try{Dl=Sl(Cl,wl,void 0,{onReady(){wl.classList.add(`ready`),kl()},onError:Al}),Dl.configure({intensity:1,pace:.75,paused:!1}),Tl.addEventListener(`click`,()=>{Ol=!Ol,Dl?.configure({intensity:1,pace:.75,paused:Ol}),kl()}),El.addEventListener(`change`,kl)}catch{Al()}