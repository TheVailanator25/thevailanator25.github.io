...
Minimal public information site for EVE Personal Assistant, with a decorative amber orb and About, Privacy and Terms pages.
...
The orb uses Three.js. Its MIT license is included at `public/THREE-LICENSE.txt` and in the built website. The orb pauses when the page is hidden, respects reduced motion and includes a manual pause control. A static visual is available if JavaScript or WebGL is unavailable.
